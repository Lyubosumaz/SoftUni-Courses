function addItem() {
    ...
    const elementAttributes = { name: "href", value: "#" };
    const elementEventListener = { type: "click", func: deleteItem };
    const deleteLink = createElement("a", "[Delete]", elementAttributes, elementEventListener);
